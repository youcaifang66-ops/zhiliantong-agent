...
INTENT_RULES = {
    "plan": {
        "keywords": ["计划", "安排", "增肌", "减脂", "塑形", "一周", "训练几天", "训练方案", "器械"],
        "patterns": [r"每周.*练", r"帮我.*计划", r"怎么.*安排", r"制定.*训练"],
    },
    "record": {
        "keywords": ["记录", "完成", "打卡", "训练日志", "组数", "次数", "重量", "RPE"],
        "patterns": [r"记录.*组", r"今天.*练了", r"完成.*次", r"打卡.*训练"],
    },
    "adjust": {
        "keywords": ["调整", "太轻", "太重", "疼痛", "疲劳", "平台期", "加重量", "减量", "恢复"],
        "patterns": [r"练完.*疼", r"重量.*调整", r"多久.*加重", r"没有.*进步"],
    },
    "report": {
